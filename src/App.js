        ...
        <div className="projects-grid">
          ...
          {/* <div className="project-card">
            ...
            <div className="project-info">
              ...
              <p className="project-description">
                A dynamic e-commerce platform built using React, Redux, and MongoDB. 
                Users can browse and purchase products.
              </p>
              <a href="https://github.com/your-username/project2" className="project-link">View on GitHub</a>
            </div>
          </div>
